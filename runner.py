...
class RnRunner(object):
    def __init__(self, device, **kwargs):
        self.model = RN2DPCA(device, **kwargs)
        self.clf = None
    ...
    def train_network(self, data_loader):
        with torch.no_grad():
            ...
            for level in range(2):
                ...
                num_patch = 0
                for step, batch in enumerate(tqdm(data_loader, desc=F'Training level {level+1}')):
        ...
        with torch.no_grad():
            ...
            for step, batch in enumerate(data_loader, 1):
                ...
                if step%eval_step==0 or step==len(data_loader):
                    ...
                    print('f1_score',f1_score(labels_all,preds , average='macro'))
